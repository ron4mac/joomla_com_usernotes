...
<div class="modal hide fade" id="collapseModal">
	<div class="modal-header">
		...
		<h3><?php echo JText::_('COM_USERNOTES_BATCH_OPTIONS'); ?></h3>
	</div>
	<div class="modal-body modal-batch">
		<p><?php echo JText::_('COM_USERNOTES_BATCH_TIP'); ?></p>
		<div class="row-fluid">
		...
		<div class="row-fluid">
			<?php if ($published >= 0) : ?>
				<div class="control-group span6">
					<div class="controls">
						<?php echo JHtml::_('batch.item', 'com_usernotes'); ?>
					</div>
				</div>
			<?php endif; ?>
			<div class="control-group span6">
	...
	<div class="modal-footer">
		...
		<button class="btn btn-primary" type="submit" onclick="Joomla.submitbutton('usernote.batch');">
